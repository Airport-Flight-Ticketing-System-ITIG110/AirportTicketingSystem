...
public class FlightRepo {
    ...
    public List<Flight> findAllFlights(FlightSearchInfo flightSearchInfo){
        ...
        for(Flight flight : this.flightList){
            if(flight.getOrigin().equals(flightSearchInfo.getOrigin())
                ...
                && isEqualDate(flight.getTime(), DateUtil.getLocalDateFromStringOnlyDate(flightSearchInfo.getTime()))){
    ...
    private List<Flight> initializeFLightData(){
        ...
        flight1.setTime(DateUtil.getLocalDateFromString("2022-10-20 11:30"));

        Flight flight2 = new Flight();
        flight2.setNumber("5678");
        flight2.setOrigin("Alex");
        flight2.setDestination("Dubai");
        flight2.setTime(DateUtil.getLocalDateFromString("2022-10-25 11:30"));
        ...
        flight3.setTime(DateUtil.getLocalDateFromString("2022-10-20 04:30"));
